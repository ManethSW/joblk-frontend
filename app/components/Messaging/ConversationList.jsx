  ...
  return (
    ...
    <div className="overflow-y-auto">
        {conversations.map((conversation) => (
            <div key={conversation.id} onClick={() => onSelectConversation(conversation.id)} className="cursor-pointer bg-green-100 p-1 hover:bg-green-300 rounded-md mt-1 mr-4 ml-4 border border-gray-500 transition duration-300">
