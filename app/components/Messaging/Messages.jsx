...
const Messages = ({ conversationId }) => {
    ...
    const fetchConversationDetails = useCallback(async () => {
        try {
            const response = await axios.get(`${process.env.NEXT_PUBLIC_API_BASE_URL}/conversation/${conversationId}`,
                {
                    headers: {
                        'auth_token': process.env.NEXT_PUBLIC_API_AUTH_TOKEN
                    },
    ...
    const sendMessage = async () => {
        try {
            await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/message/${conversationId}`,
